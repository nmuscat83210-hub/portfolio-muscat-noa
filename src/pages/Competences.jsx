...
const competencesGEII = [
  ...
  },
  {
    ...
    levelImages: [
      [
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/5cea02553_NIVEAU1PHOTO1.png",
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/32fd04dc5_NIVEAU1PHOTO2.png",
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/fe7ecf9ab_NIVEAU1PHOTO3.png",
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/7bc11f406_NIVEAU1PHOTO4.png",
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/3aa5ca9c8_NIVEAU1PHOTO5.png",
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/52991988b_NIVEAU1PHOTO6.png",
        "https://media.base44.com/images/public/693a7c34a791a122b93f4ce7/2d50f1adb_NIVEAU1PHOTO7.png"
      ],
      [
    ...
    why: {
      ...
      en: "🔹 Level 1 – 100%\n\nOfficial level: \"Perform the tests and measurements necessary to verify a system\". Fully mastered: I performed daily electrical and physical checks at Kontron (ground continuity tests with a micro-ohmmeter, power supply voltage measurements, visual compliance inspections). My experience at Europe Qualité reinforced this practice through rigorous calibration campaigns on measuring instruments (multimeter, decade box, spectrum analyzer, type K thermocouple probe).\n\n🔹 Level 2 – 100%\n\nOfficial level: \"Set up a test protocol to validate the operation of a system\". Fully mastered: I executed Burn-in endurance test protocols, performed predictive diagnostics on hard drives, and deployed automated Python scripts under Linux to stress network links. I also managed ESD environment checks with a tera-ohmmeter.\n\n🔹 Level 3 – 100%\n\nOfficial level: \"Develop a procedure integrating a quality approach to validate the operation of a system\". Fully mastered: I wrote official intervention procedures at Kontron and managed the laboratory's internal metrology (weekly tracking of torque screwdrivers on a test bench, rack metrology) under ISO 9001 and EN 9100 constraints. At Europe Qualité, I wrote official calibration certificates and validated monitoring solutions in the BUT GEII program (Shelly EM, IoT)."
    },
    fromCourses: {
